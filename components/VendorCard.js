  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center justify-center w-full mt-5 bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 text-white px-4 py-2.5 rounded-lg font-medium transition-all relative overflow-hidden group"
        whileTap={{ scale: 0.98 }}
